...
protected:
    ...
    JsonMealRepository repo{"/home/anas/personal_projects/calorie-counter-backend/json_data_base_meals.json"};
...
TEST_F(JsonMealRepositoryTest,save_and_data_base_empty) {
    ...
    JsonMealRepository repo_temp{"/home/anas/personal_projects/calorie-counter-backend/json_data_base_meals.json"};
    ...
    EXPECT_EQ(repo_temp.getById(meal.id()).unwrap().food_items()[0].second,food.servingSizeG().value());
    std::remove("/home/anas/personal_projects/calorie-counter-backend/json_data_base_meals.json");
}

TEST_F(JsonMealRepositoryTest,save_wrong_path_to_data_base) {

    JsonMealRepository repo_temp{"/home/ansss/personal_projects/calorie-counter-backend/json_data_base_meals.json"};
...
TEST_F(JsonMealRepositoryTest,list_cant_open_data_base) {
    //wrong_path
    JsonMealRepository repo_temp{"/home/anasss/personal_projects/calorie-counter-backend/json_data_base_temp.json"};
    EXPECT_EQ(repo_temp.save(meal).unwrap_error().code,cc::utils::ErrorCode::StorageError);
...
TEST_F(JsonMealRepositoryTest,remove) {
    ...
    JsonMealRepository repo_temp{"/home/anas/personal_projects/calorie-counter-backend/json_data_base_temp.json"};
...
TEST_F(JsonMealRepositoryTest,upsert) {
    JsonMealRepository repo_temp{"/home/anas/personal_projects/calorie-counter-backend/json_data_base_temp_debug_upsert.json"};
...
TEST_F(JsonMealRepositoryTest,upsert_wrong_path) {
    JsonMealRepository repo_temp{"/home/anasss/personal_projects/calorie-counter-backend/json_data_base_temp_debug_upsert.json"};

    EXPECT_EQ(repo_temp.upsert(meal).unwrap_error().code,cc::utils::ErrorCode::StorageError);

    std::remove("/home/anasss/personal_projects/calorie-counter-backend/json_data_base_temp_debug_upsert.json");
    }
