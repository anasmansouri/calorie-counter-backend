...
protected:
    void SetUp() override {                // runs BEFORE each TEST_F
        ...
        cc::storage::JsonFoodRepository repo{"/home/anas/personal_projects/calorie-counter-backend/json_data_base.json"};
        cc::clients::OpenFoodFactsClient client;
        std::shared_ptr<cc::storage::JsonFoodRepository> repo_shared_ptr= std::make_shared<cc::storage::JsonFoodRepository>(repo);
        std::shared_ptr<cc::clients::OpenFoodFactsClient> client_ptr = std::make_shared<cc::clients::OpenFoodFactsClient>(client);
...
TEST_F(FoodServiceTest,listFoods) {
        cc::clients::OpenFoodFactsClient client;
        std::shared_ptr<cc::storage::JsonFoodRepository> repo_shared_ptr= std::make_shared<cc::storage::JsonFoodRepository>("/home/anas/personal_projects/calorie-counter-backend/json_data_base.json");
        std::shared_ptr<cc::clients::OpenFoodFactsClient> client_ptr = std::make_shared<cc::clients::OpenFoodFactsClient>(client);
        FoodService food_service{repo_shared_ptr,client_ptr};
...
TEST_F(FoodServiceTest,listFoods_data_base_path_is_wrong) {
        cc::clients::OpenFoodFactsClient client;
        std::shared_ptr<cc::storage::JsonFoodRepository> repo_shared_ptr= std::make_shared<cc::storage::JsonFoodRepository>("/home/anasss/personal_projects/calorie-counter-backend/json_data_base.json");
        std::shared_ptr<cc::clients::OpenFoodFactsClient> client_ptr = std::make_shared<cc::clients::OpenFoodFactsClient>(client);
        FoodService food_service{repo_shared_ptr,client_ptr};
        ;
        EXPECT_EQ(food_service.clear_data_base().unwrap_error().code, cc::utils::ErrorCode::StorageError);
...
TEST_F(FoodServiceTest,addManualFood_wrong_path_to_data_base) {
        ...
        food_service.addManualFood(food);
        EXPECT_EQ(food_service.listFoods().unwrap_error().code, cc::utils::ErrorCode::NotFound);
        EXPECT_EQ(food_service.addManualFood(food).unwrap_error().code, cc::utils::ErrorCode::StorageError);
    }

TEST_F(FoodServiceTest,updateFood) {
        cc::clients::OpenFoodFactsClient client;
        std::shared_ptr<cc::storage::JsonFoodRepository> repo_shared_ptr= std::make_shared<cc::storage::JsonFoodRepository>("/home/anas/personal_projects/calorie-counter-backend/json_data_base_temp_.json");
        std::shared_ptr<cc::clients::OpenFoodFactsClient> client_ptr = std::make_shared<cc::clients::OpenFoodFactsClient>(client);
        FoodService food_service{repo_shared_ptr,client_ptr};
        food_service.clear_data_base();
        EXPECT_EQ(food_service.listFoods().unwrap().size(), 0);
...
TEST_F(FoodServiceTest,updateFood_wrong_path_to_data_base) {
        ...
        food.setNutrients({{"Protein",24,"g"},{"Carbs",100,"g"}});
        EXPECT_EQ(food_service.addManualFood(food).unwrap_error().code, cc::utils::ErrorCode::StorageError);
        EXPECT_EQ(food_service.updateFood(food).unwrap_error().code, cc::utils::ErrorCode::StorageError);
    }
...
TEST_F(FoodServiceTest,deleteFood_wrong_id) {
        ...
        EXPECT_EQ(food_service.deleteFood(wrong_id).unwrap_error().code,cc::utils::ErrorCode::StorageError);
        EXPECT_EQ(food_service.listFoods().unwrap().size(), 1);
        std::remove("/home/anas/personal_projects/calorie-counter-backend/json_data_base_temp_.json");
    }
